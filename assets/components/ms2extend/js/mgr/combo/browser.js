...
Ext.extend(ms2Extend.combo.Browser, Ext.form.TriggerField,{
    browser: null
    ...
    ,onDestroy: function(){
        ms2Extend.combo.Browser.superclass.onDestroy.call(this);
    }
    ,getPath: function(n) {
        if (n.id == '/') {return '';}
        data = n.attributes;
...
Ext.reg('ms2extend-combo-browser', ms2Extend.combo.Browser);