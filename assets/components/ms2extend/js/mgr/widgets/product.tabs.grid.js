ms2Extend.grid.productTabs = function(config) {
	...
	Ext.applyIf(config, {
		...
		columns: [
			...
			{header:_('ms2ext.field.name'), dataIndex:'name', sortable:true, width:0.2, editor:{xtype:'textfield'}},
			{header:_('ms2ext.field.tab.fields'), dataIndex:'fields', sortable:true, width:0.75, editor:{xtype:'textarea'}}
		],
