...
ms2Extend.combo.multiSelectLocal = function (config) {
    config = config || {};
    Ext.applyIf(config, {
        //Custom settings
    ...
    config.name += '[]';
    config.hiddenName += '[]';
    ms2Extend.combo.multiSelectLocal.superclass.constructor.call(this, config);
};
Ext.extend(ms2Extend.combo.multiSelectLocal, Ext.ux.form.SuperBoxSelect);
