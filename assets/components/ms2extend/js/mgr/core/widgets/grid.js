...
ms2Extend.grid.abstract = function (config) {
    config = config || {};
    Ext.applyIf(config, {
        //Custom settings
        url: null,
    ...
    ms2Extend.grid.abstract.superclass.constructor.call(this, config)
};
Ext.extend(ms2Extend.grid.abstract, MODx.grid.Grid, {
    ...
    initComponent: function () {
        ...
        ms2Extend.grid.abstract.superclass.initComponent.call(this);
    },
    ...
    getGridColumn: function (name, config = {}) {
        return ms2Extend.component.gridColumn(name, config);
    },
