...
abstract class ms2ExtendMgrDefaultController extends modExtraManagerController
{
    use ms2ExtendControllerHelperService;
    use ms2ExtendControllerHelperAssets;
    use ms2ExtendControllerHelperRichText;
